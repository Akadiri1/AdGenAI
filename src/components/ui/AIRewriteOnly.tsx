...
/**
 * AI Polish button — rewrites existing text. Shows a preview that user can accept or reject.
 * Used for Brand Kit fields where users must provide their own content.
 */
export function AIRewriteOnly({
  value,
  onChange,
  fieldType = "generic",
  maxLength,
  ...
  return (
    <>
      ...
      {suggestion && (
        <div className="mt-2 rounded-xl border-2 border-accent/30 bg-accent/5 p-3">
