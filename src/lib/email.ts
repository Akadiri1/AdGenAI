...
export function teamInviteEmail(params: {
  ...
  return {
    subject: `You've been invited to join ${params.teamName} on AdGenAI`,
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 500px; margin: 0 auto; padding: 40px 20px;">
        <div style="text-align: center; margin-bottom: 30px;">
          ...
          <span style="font-size: 20px; font-weight: 800; margin-left: 8px; color: #1A1A2E;">AdGenAI</span>
        </div>
        ...
        <p style="color: #6B7280; line-height: 1.6;">
          ...
          <strong style="color: #1A1A2E;">${params.teamName}</strong> as a <strong>${params.role}</strong> on AdGenAI.
        </p>
        <p style="color: #6B7280; line-height: 1.6;">
          AdGenAI is an AI-powered ad creation platform. Create professional ads in 30 seconds — no marketing degree needed.
        </p>
